...
//
    ...
    public ResponseEntity<String> transaction1_dirty_write(@RequestParam Integer userId) throws InterruptedException {
    ...
    public ResponseEntity<String> transaction1_lost_update(@RequestParam Integer userId) throws InterruptedException {
